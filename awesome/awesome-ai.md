...
- https://mlcourse.ai/
- Hugging Face запустил официальный курс по MCP - комплексное руководство по изучению Model Context Protocol (MCP), включающее теоретические основы архитектуры MCP-серверов, практические навыки их использования и разработку собственных MCP-приложений с возможностью получения сертификата по завершению обучения. https://huggingface.co/learn/mcp-course/unit0/introduction
